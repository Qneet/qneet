...
public struct TestIdProvider
{
    ...
    public void AppendString(string str)
    {
        ...
        var end = Math.Min(BlockBytes - m_position, byteCount);
    ...
    public Guid GetId()
    {
        ...
        var toGuid = new byte[DigestBytes];
        GetHash(toGuid);
        return new Guid(toGuid.AsSpan(0, 16));
    }
    ...
    public struct Sha1Implementation
    {
        ...
        private void ProcessMultipleBlocks(Span<byte> message)
        {
        ...
        public void ProcessBlock(Span<byte> message)
        {
